...
\includepdf[scale=1, offset=7mm 0mm, pagecommand={\section*{Appendix A: Class Diagram}\pagestyle{fancy}}\label{sec:appendixa}]{../diagrams/class/class.png}
...
% \includepdf[scale=1, offset=7mm 0mm, pagecommand={\section*{Appendix B: New Class Diagram for RotLA}\pagestyle{fancy}}\label{sec:appendixb}]{../uml/class_diagram/game_diagram.png}
