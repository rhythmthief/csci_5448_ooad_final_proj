...
\includepdf[scale=1, offset=0mm 0mm, pagecommand={\section*{Appendix C: Activity Diagram}\pagestyle{fancy}}\label{sec:appendixc}]{../diagrams/activity/Project5_ActivityDiagram.drawio.png}
...
\includepdf[scale=1, offset=0mm 0mm, pagecommand={\section*{Appendix E: Use Cases}\pagestyle{fancy}}\label{sec:appendixe}]{../diagrams/use_cases/use_cases.png}
