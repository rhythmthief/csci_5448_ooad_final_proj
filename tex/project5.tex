...
\includepdf[scale=0.9, offset=0mm 0mm, pagecommand={\section*{Appendix A: Class Diagram}\pagestyle{fancy}}\label{sec:appendixa}]{../diagrams/class/class.png}
...
\includepdf[scale=1, offset=0mm 0mm, pagecommand={\section*{Appendix B: UI Sketches}\pagestyle{fancy}}\label{sec:appendixb}]{../diagrams/ui_sketches/PXL_20221102_214317894.jpg}

\includepdf[scale=1, offset=0mm 0mm, pagecommand={\pagestyle{fancy}}]{../diagrams/ui_sketches/PXL_20221102_223452233.jpg}
...
\includepdf[scale=0.95, offset=0mm 0mm, pagecommand={\section*{Appendix C: Activity Diagram}\pagestyle{fancy}}\label{sec:appendixc}]{../diagrams/activity/Project5_ActivityDiagram.drawio.png}
...
\includepdf[scale=0.5, offset=0mm 0mm, pagecommand={\section*{Appendix D: Architecture Diagram}\pagestyle{fancy}}\label{sec:appendixd}]{../diagrams/architecture/architectureDiagram.drawio.png}
...
\includepdf[scale=0.9, offset=0mm 0mm, pagecommand={\section*{Appendix E: Use Cases}\pagestyle{fancy}}\label{sec:appendixe}]{../diagrams/use_cases/use_cases.png}
...
\includepdf[scale=0.9, offset=0mm 0mm, pagecommand={\section*{Appendix F: User Interaction Sequence Diagrams}\pagestyle{fancy}}\label{sec:appendixf}]{../diagrams/user_sequence/UserSequence.drawio.png}
